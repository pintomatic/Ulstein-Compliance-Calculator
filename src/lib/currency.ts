...
export const EUR_TO_USD = Number(process.env.NEXT_PUBLIC_EUR_TO_USD) || 1.17;
export const ALLOWANCE_PRICE_EUR = Number(process.env.NEXT_PUBLIC_ALLOWANCE_PRICE_EUR) || 77;
export const ALLOWANCE_PRICE_USD = ALLOWANCE_PRICE_EUR * EUR_TO_USD;
...
export const MODULE_PRICING_USD = {
  complianceCore: Number(process.env.NEXT_PUBLIC_MODULE_PRICING_USD_COMPLIANCE) || 10000,
  fuelPlusAddOn: Number(process.env.NEXT_PUBLIC_MODULE_PRICING_USD_FUELPLUS) || 5000,
  hardwareOneOff: Number(process.env.NEXT_PUBLIC_HARDWARE_ONEOFF_USD) || 15000,
};
